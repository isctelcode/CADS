...
namespace Struct19
{
    ...
    class TreeSet<T>
    {
        ...
        private void SubSet(Node<T> x, T fromElement, T toElement)
        {
            if (x == null)
            {
                return;
        ...
        private void HeadSet(Node<T> x, T toElement)
        {
            if (x == null)
            {
                return;
        ...
        private void TailSet(Node<T> x, T fromElement)
        {
            if (x == null)
            {
                return;
        ...
        private void SubSet(Node<T> x, T lowerBound, bool lowIncl, T upperBound, bool highIncl)
        {
            if (x == null)
            {
                return;
        ...
        private void HeadSet(Node<T> x, T upperBound, bool highIncl)
        {
            if (x == null)
            {
                return;
        ...
        private void TailSet(Node<T> x, T lowerBound, bool lowIncl)
        {
            if (x == null)
            {
                return;
        ...
        public TreeSet(TreeSetComparer<T> comparer)
        {
            root = null;
            size = 0;
