...
namespace Struct28
{
    ...
    class MyVector<T>
    {
        ...
        public MyItr<T> ListIterator(int index)
        {
            ...
            T[] iterList = new T[vector.Length - index];
            for (int i = index, j = 0; i < vector.Length; ++i, ++j)
            {
                iterList[j] = vector[i];
            }
        ...
        public T[] SubList(int fromIndex, int toIndex)
        {
            ...
            {
                throw new InvalidIntervalArgumentVectorException();
            }
