...
namespace Struct28
{
    ...
    public class MyLinkedList<T>
    {
        ...
        {
            T[] linkedList = ToArray();
            if (index < 0 || index >= linkedList.Length)
            {
                throw new IndexOutOfRangeLinkedListException();
            }

            T[] iterList = new T[linkedList.Length - index];
            for (int i = index, j = 0; i < linkedList.Length; ++i, ++j)
            {
                iterList[j] = linkedList[i];
            }
        ...
        public MyLinkedList(T[] array)
        {
            ...
            {
                MyLinkedListNode<T> node = new MyLinkedListNode<T>(array[i]);
        ...
        public void Add(T element)
        {
            try
            {
                MyLinkedListNode<T> node = new MyLinkedListNode<T>(element);
        ...
        public void Add(int index, T element)
        {
            try
            {
                ...
                if (node == null)
                {
                    MyLinkedListNode<T> newNode = new MyLinkedListNode<T>(element);
                    newNode.Next = null;
                    newNode.Prev = tail;
                    tail.Next = newNode;
                    tail = newNode;
        ...
        public T[] SubList(int fromIndex, int toIndex)
        {
            ...
            {
                throw new InvalidIntervalArgumentLinkedListException();
            }
