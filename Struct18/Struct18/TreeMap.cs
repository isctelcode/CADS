...
namespace Struct18
{
    ...
    class TreeMap<T>
    {
        ...
        private void SwapValues(Node<T> x1, Node<T> x2)
        {
        ...
        private Node<T> Replace(Node<T> x)
        {
        ...
        private bool ContainsValue(Node<T> x, T value)
        {
            if (x == null)
            {
                return false;
        ...
        private void EntrySet(Node<T> x)
        {
            if (x == null)
            {
                return;
        ...
        private void HeadMap(Node<T> x, int end)
        {
            if (x == null)
            {
                return;
        ...
        private void SubMap(Node<T> x, int begin, int end)
        {
            if (x == null)
            {
                return;
        ...
        private void TailMap(Node<T> x, int begin)
        {
            if (x == null)
            {
                return;
        ...
        private Tuple<int, T> PollFirstEntry(Node<T> x)
        {
            if (x.Left == null)
            {
        ...
        private Tuple<int, T> PollLastEntry(Node<T> x)
        {
            if (x.Right == null)
            {
                Tuple<int, T> first = x.Value;
        ...
        private Tuple<int, T> FirstEntry(Node<T> x)
        {
            if (x.Left == null)
            {
                Tuple<int, T> first = x.Value;
        ...
        private Tuple<int, T> LastEntry(Node<T> x)
        {
            if (x.Right == null)
            {
                Tuple<int, T> first = x.Value;
        ...
        public TreeMap(TreeMapComparer<T> comparer)
        {
            root = null;
            size = 0;
